...
const WHATS_NEW = "Home answers what now: the greeting is the page's own voice with one action beside it, and cards only appear once they have something to say.";
