...
const VIEWS=[
  ...
  ['viewTimeline','timeline']                                    // v4.36 (R174): teas over time
];
...
ok(VIEWS.length===20, 'C: all 20 top-level views are listed — a new view added to render() must be added here too (got '+VIEWS.length+')');   // v4.36 (R174): +timeline
...
const SUBSTANTIAL=['viewDashboard','viewInsights','viewTeas','viewTeaDetail','viewSessions',
                   ...
                   'viewRitual','viewPalate','viewTimeline'];   // v4.30 (R172) + v4.36 (R174): the reflection deep pages must produce real markup too
