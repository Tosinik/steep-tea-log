...
self.APP_VERSION = 'v4.26';
// WHATS_NEW — one human sentence, the quiet second line on the update banner (v3.69+). '' suppresses it.
self.WHATS_NEW = "Insights gets the quieter, papery look — the stat numbers become a ledger, a few duplicate cards are gone, and the wording is plainer.";
