...
self.APP_VERSION = 'v4.31';
// WHATS_NEW — one human sentence, the quiet second line on the update banner (v3.69+). '' suppresses it.
self.WHATS_NEW = "Groundwork for smarter, character-based brewing advice — your cup feedback keeps being recorded while the new version is built.";
