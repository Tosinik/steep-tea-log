...
self.APP_VERSION = 'v4.27';
// WHATS_NEW — one human sentence, the quiet second line on the update banner (v3.69+). '' suppresses it.
self.WHATS_NEW = "Home gets warm — bold tea-liquor colour, a daily insight that opens onto Insights, and a cleaner, whiter paper across the whole app.";
